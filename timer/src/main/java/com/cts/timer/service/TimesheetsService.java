...
public interface TimesheetsService {
	...
	public abstract void approveReject(List<Long> timeentryIds, String status);
	
	public abstract List<Timeentry> findByDateAndEmployeeId(LocalDate date, Long employeeId);
